  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        // 错误态优先于空态：断网/超时不能伪装成"还没有收藏"
        if (_controller.hasError && _controller.favoriteList.isEmpty) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              onPressed: () => _controller.loadFavorites(refresh: true),
